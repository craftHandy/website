...
//                 className="h-auto w-36 xl:w-40 2xl:w-44"
//               />
//             </div>
//           </Link>
...
//               ) : (
//                 <MoonStar className="size-5 text-white" />
//               )}
//             </button>
...
//             className="lg:hidden bg-[#131313] border-t border-[#3a3428] overflow-hidden"
//           >
//             <div className="max-h-[75vh] overflow-y-auto overscroll-contain px-4 py-6 space-y-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
//               {/* Mobile Theme Toggle */}
...
//                 <div className="space-y-2 pl-2 max-h-56 overflow-y-auto overscroll-contain [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
//                   {categories.length === 0 ? (
    ...
    <header className="sticky top-0 z-50 bg-[#131313] text-white border-b border-[#3a3428] shadow-[0_4px_30px_rgba(0,0,0,0.25)]">
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-2">
          ...
          <Link href="/" className="group shrink min-w-0">
            <div className="flex items-center gap-4">
              <img
                src="/header.png"
                alt="Ratna Treasure Handicraft"
                className="h-auto w-24 sm:w-32 lg:w-36 xl:w-40 2xl:w-44 max-w-full"
              />
            </div>
          </Link>
          ...
          <div className="flex items-center gap-1 sm:gap-3 text-white shrink-0">
            {/* Search - hidden on the smallest screens, still available via mobile menu below */}
            <button
              type="button"
              onClick={() => setSearchOpen(!searchOpen)}
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div className="max-h-[75vh] overflow-y-auto overscroll-contain px-4 py-6 space-y-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              {/* Mobile Search (only needed here on the smallest screens where the top-row icon is hidden) */}
              {/* <form action="/product" method="GET" className="flex gap-2 xs:hidden">
                <Input
                  name="search"
                  placeholder="Search products..."
                  className="flex-1 bg-[#1e1e1e] border-[#3a3428] text-white placeholder:text-[#9a7b2c] focus:border-[#e9c176] focus:ring-[#e9c176]"
