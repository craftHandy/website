    ...
    <main className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)]">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 text-[var(--color-cream-dark)]/70">
          ...
          <section>
            <h2 className="text-xl font-serif text-[var(--color-foreground)] mb-4">Temple Jewelry</h2>
            <p className="text-sm leading-relaxed mb-3 font-poppins">
          ...
          <section>
            <h2 className="text-xl font-serif text-[var(--color-foreground)] mb-4">Kundan & Jadau</h2>
            <p className="text-sm leading-relaxed mb-3 font-poppins">
          ...
          <section>
            <h2 className="text-xl font-serif text-[var(--color-foreground)] mb-4">Silver Jewelry</h2>
            <p className="text-sm leading-relaxed mb-3 font-poppins">
          ...
          <section>
            <h2 className="text-xl font-serif text-[var(--color-foreground)] mb-4">Gemstone Jewelry</h2>
            <p className="text-sm leading-relaxed mb-3 font-poppins">
          ...
          <section>
            <h2 className="text-xl font-serif text-[var(--color-foreground)] mb-4">Professional Cleaning</h2>
            <p className="text-sm leading-relaxed font-poppins">
              ...
              <span className="text-gold">ratnacraft@gmail.com</span> to schedule a professional cleaning for your Ratnagiri pieces.
            </p>
          </section>
        </div>
      </div>
